<template>
  <view class="articleDetail">
    ...
    <view class="content">
      ...
      <image
        src="../../static/images/article/articleDetail.jpg"
        mode="widthFix"
      ></image>
...
export default {
  data() {
    return {
      ...
      articleDetail: {
        title:
          '【刚刚】广州新增7+2，具体情况如下！多区最新通告！这些区域恢复线下教学',
        ...
        like: 98,
        content:
          '9月3日0-24时，全省新增本土确诊病例79例（广州4例，深圳69例，江门6例）；新增本土无症状感染者24例（深圳20例，东莞1例，江门2例，揭阳1例）。全省新增境外输入确诊病例17例（广州5例，深圳8例，珠海2例，佛山2例）；新增境外输入无症状感染者14例（广州1例，深圳4例，珠海2例，佛山3例，惠州1例，东莞2例，中山1例）；另有1例境外输入无症状感染者转确诊病例（广州1例）。',
      },
    }
  },
  methods: {
